# Generic Erlang CoAP Client/Server [![Build status](https://github.com/emqx/er_coap_client/actions/workflows/main.yml/badge.svg)](https://github.com/emqx/er_coap_client/actions/workflows/main.yml)
